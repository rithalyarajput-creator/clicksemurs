...
export default function Projects() {
  ...
  return (
    <div style={{ overflowX: 'hidden' }}>
      ...
      {/* Hero */}
      <section style={{ background: 'linear-gradient(135deg, #1a1a1a 0%, #111827 60%, #1a1a1a 100%)', padding: 'clamp(96px,12vw,140px) 0 clamp(56px,6vw,72px)', position: 'relative', overflow: 'hidden' }}>
